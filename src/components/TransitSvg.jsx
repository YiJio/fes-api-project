...
const IconHighSpeedRail = ({ size, color }) => {
	return (
		<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.75 24" height={size}>
...
const IconMetro = ({ size, color }) => {
	return (
		<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 24" height={size}>
			<g id="Layer_1-2" data-name="Layer 1">
				<g>
...
const IconMonorail = ({ size, color }) => {
	return (
		<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 24" height={size}>
			<g id="Layer_1-2" data-name="Layer 1">
				<g>
