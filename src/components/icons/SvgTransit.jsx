...
const IconHighSpeedRail = ({ cursor = 'default', size, width, height, color }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width={size || width} height={size || height} viewBox="0 0 17.75 24" style={{ cursor: cursor }}>
			<g>
...
const IconTrain = ({ cursor = 'default', size, width, height, color }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width={size || width} height={height} viewBox="0 0 17.75 24" style={{ cursor: cursor }}>
			<g>
...
const IconMetro = ({ cursor = 'default', size, width, height, color }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width={size || width} height={height} viewBox="0 0 20 24" style={{ cursor: cursor }}>
			<g>
				<g>
...
const IconMonorail = ({ cursor = 'default', size, width, height, color }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width={size || width} height={height} viewBox="0 0 16 24" style={{ cursor: cursor }}>
			<g>
				<g>
